...
<body>
	<form id="userAction_save_do" name="Form1"
		action="${pageContext.request.contextPath}/alterEnterprise" method="post"
		>
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4"
					height="26"><strong><STRONG>编辑企业</STRONG> </strong></td>
			</tr>
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="name" class="bg" value="${en.name }" /></td>
			</tr>
			<tr>
				<td align="center" bgColor="#f5fafe" class="ta_01">企业法人：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="corporate" class="bg" value="${en.corporate }" /></td>
				<td align="center" bgColor="#f5fafe" class="ta_01">企业类别：</td>
				<td class="ta_01" bgColor="#ffffff"><select name="nature"
					id="category">
						<option value="">--选择企业类加--</option>
			...
			<td align="center" bgColor="#f5fafe" class="ta_01">企业电话：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="telephone" class="bg" value="${en.telephone }" /></td>
			
			<TR>
				<TD class="ta_01" align="center" bgColor="#f5fafe">企业描述：</TD>
				<TD class="ta_01" bgColor="#ffffff" colSpan="3"><textarea
						name="introduce" cols="30" rows="3" style="WIDTH: 96%">${en.introduce}</textarea>
				</TD>
			</TR>
			<TR>
