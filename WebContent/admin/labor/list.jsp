	...
	<form id="Form1" name="Form1" action="#" method="post">
		<table cellSpacing="1" cellPadding="0" width="100%" align="center"
			...
			<TBODY>
				...
				<tr>
					<td class="ta_01" align="center" bgColor="#afd1f3"><strong>劳工信息列
							表</strong></TD>
				</tr>
				<tr>
						...
						<c:forEach items="${labors}" var="l">
							<tr onmouseover="this.style.backgroundColor = 'white'"
								...
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="10%">${l.name }</td>
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="15%">${l.gender }</td>
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="10%">${l.telephone }</td>
								<td style="CURSOR: hand; HEIGHT: 22px" align="center">
									${l.skill }</td>
								<td width="8%" align="center">${l.address }</td>
								<td width="10%" align="center">${l.QQ }</td>
