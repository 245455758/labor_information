						...
						<tr>
							<td>
								...
								<div style="margin-top: 20px; margin-bottom: 5px">
									<img
										src="${pageContext.request.contextPath }/images/entlist.png"
										width="100%" height="38" />
								</div>

								<table cellspacing="0" class="booklist">
									<tr>
										<c:forEach items="${pb.enterprises }" var="b">
											<td>

												<div class="divbookpic">
													<p>
														<a
															href="${pageContext.request.contextPath }/findEntInfoServlet?id=${b.id}"><img
															src='enterprise/${b.img_url}' width="115" height="129"
															border="0" /> </a>
													</p>
												</div>
												...
												<div class="divlisttitle">
													<a
														href="${pageContext.request.contextPath }/findEntInfoServlet?id=${b.id}">企业名:${b.name
														}<br />
													</a>
												</div>
											</td>
